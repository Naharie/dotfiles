...
stdenv.mkDerivation rec {
  pname = "godot-bleeding";
  version = "4.3.0";
  commitHash = "d282e4f0e6b6ebcf3bd6e05cd62f2a8fe1f9a238";

  src = fetchFromGitHub {
    owner = "godotengine";
    repo = "godot";
    rev = commitHash;
    hash = "sha256-qNA8Nj3rsDlsLVcpsznmJsBhQl6rICHQjNhBA5goHoE=";
  };
  ...
  installPhase = ''
    ...
    substituteInPlace "$out/share/applications/org.godotengine.Godot4.desktop" \
      ...
      --replace "Godot Engine" "Godot Engine Bleeding"
